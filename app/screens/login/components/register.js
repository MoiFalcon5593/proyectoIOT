    ...
    return (
        <ImageBackground style={styles.containerhead} source={require("../../../../assets/wp-verde.jpg")}>
            <View style={styles.top}>
                ...
                <Text style={styles.txt_white}>Crear Usuario</Text>
            </View>
            ...
            <View style={styles.container_input}>
                ...
                />
                {
                    showPassword ? <Icon name='md-eye-off-outline' color="#3069e8" size={20} style={{ marginRight: 10 }}
                        onPress={() => setShowPassWord(false)} /> :
                        <Icon name='ios-eye-outline' color="#3069e8" size={20} style={{ marginRight: 10 }}
