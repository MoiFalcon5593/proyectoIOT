...
import { AddRegistersTipFertilizantes, AddRegistersTipRiesgo } from '../../../actions/ProductionActions';
export default function RegisterFertilizante(props) {
    ...
    const listas  = useSelector(reducers => reducers.ProductionReducer).ListTipFertilizantes;
    console.log(listas);
    ...
    const onSubmmmit = async () => {
        ...
        dispatch(AddRegistersTipFertilizantes(nombre, costo, cantidad))
        Alert.alert(
            "Satisfactorio",
            "Nuevo tipo de fertilizante creado",
            [
                {
                    text: "Ok",
        ...
        <ImageBackground style={styles.containerhead} source={require("../../../../assets/bg-home.png")}>
            <View style={styles.top}>
                <Row_simple jus_cont={'space-evenly'} flex={1}>
                    ...
                    <Colum_simple jus_cont={'center'} alitems={'center'} flex={1} >
                        <Text style={styles.txt_white}>Registro de Fertilizante</Text>
                    </Colum_simple>
                </Row_simple>
            </View>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.container_input}>
                    <TextInput
                        placeholder='Costo de Fertilizante'
                        placeholderTextColor="#7c7878"
                        keyboardType="default"
